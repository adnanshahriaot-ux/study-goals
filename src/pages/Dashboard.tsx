                        ...
                        {activeMobileTab === 'dashboard' && (
                            <div className="space-y-3 animate-fadeIn">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-gradient-to-tr from-accent-purple to-accent-blue rounded-xl flex items-center justify-center text-lg shadow-lg shadow-accent-purple/20">
                                        🎓
                                    </div>
                                    <div>
                                ...
                                <div className="glass-card p-3 rounded-xl border border-accent-green/20 bg-gradient-to-br from-emerald-900/20 to-slate-800/50">
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <span className="text-[10px] font-bold text-accent-green uppercase">Progress</span>
                                    </div>
                                ...
                                <div className="glass-card p-3 rounded-xl border border-accent-blue/20 bg-gradient-to-br from-blue-900/30 via-slate-800/50 to-purple-900/30">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-[10px] font-bold text-accent-blue uppercase">{settings.countdownSettings.title || 'Countdown'}</span>
                                        <span className="text-[9px] text-gray-500">{settings.countdownSettings.targetDate}</span>
                                    </div>
                                    <div className="grid grid-cols-4 gap-2">
                                        {timeLeft.map((t, i) => (
                                            <div key={i} className="flex flex-col items-center">
                                                <div className={`w-full py-2 rounded-lg flex items-center justify-center ${i === 3 ? 'bg-accent-green/20' : 'bg-white/5'}`}>
                                                    <span className={`text-base font-black ${i === 3 ? 'text-accent-green' : 'text-white'}`}>{t}</span>
                                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className="glass-card p-3 rounded-xl border border-accent-purple/20 hover:border-accent-purple/40 transition-all group"
                                    >
                                        <div className="flex items-center gap-2">
                                            <span className="text-lg">🎯</span>
                                            <div>
                                                <span className="text-xs font-bold text-white block">{sortedTargetCards.length} Targets</span>
                                            </div>
                                        </div>
                                    </button>
                                    <button
                                        onClick={() => setActiveMobileTab('daily')}
                                        className="glass-card p-3 rounded-xl border border-accent-cyan/20 hover:border-accent-cyan/40 transition-all group"
                                    >
                                        <div className="flex items-center gap-2">
                                            <span className="text-lg">📅</span>
                                            <div>
                                                <span className="text-xs font-bold text-white block">{sortedDailyDates.length} Days</span>
                                            </div>
                                        </div>
                                    </button>
                                </div>
