...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="xl">
            <div className="flex flex-col md:flex-row h-[550px] md:h-[480px] overflow-hidden rounded-2xl bg-bg-card border border-white/10">
                {/* Sidebar */}
                ...
                <div className="flex-1 p-4 md:p-6 bg-gradient-to-br from-bg-card to-bg-card/50 overflow-y-auto custom-scrollbar">
                    ...
                    {activeTab === 'account' && (
                        <div className="space-y-4 animate-fadeIn">
                            ...
                            <Button variant="danger" onClick={logout} className="w-full py-2.5 rounded-xl text-sm font-semibold border border-red-500/20 hover:bg-red-500/10">
                                Sign Out
                            </Button>
                        </div>
                    )}
